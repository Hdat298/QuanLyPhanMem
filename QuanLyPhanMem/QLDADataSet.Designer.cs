...
namespace QuanLyPhanMem {
    ...
    public partial class QLDADataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public NhanVienRow AddNhanVienRow(string MaNhanVien, string TenNhanVien, string Phai, System.DateTime NgaySinh, string DiaChi, string SDT, string Email) {
...
namespace QuanLyPhanMem.QLDADataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([MaNhanVien], [TenNhanVien], [Phai], [NgaySinh], [DiaChi], [SDT], [Email]) VALUES (@MaNhanVien, @TenNhanVien, @Phai, @NgaySinh, @DiaChi, @SDT, @Email);
SELECT MaNhanVien, TenNhanVien, Phai, NgaySinh, DiaChi, SDT, Email FROM NhanVien WHERE (MaNhanVien = @MaNhanVien)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [MaNhanVien] = @MaNhanVien, [TenNhanVien] = @TenNhanVien, [Phai] = @Phai, [NgaySinh] = @NgaySinh, [DiaChi] = @DiaChi, [SDT] = @SDT, [Email] = @Email WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ([TenNhanVien] = @Original_TenNhanVien) AND ([Phai] = @Original_Phai) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ([SDT] = @Original_SDT) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT MaNhanVien, TenNhanVien, Phai, NgaySinh, DiaChi, SDT, Email FROM NhanVien WHERE (MaNhanVien = @MaNhanVien)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyPhanMem.Properties.Settings.Default.QLDAConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNhanVien, TenNhanVien, Phai, NgaySinh, DiaChi, SDT, Email FROM dbo.NhanV" +
                "ien";
        ...
        public virtual int Delete(string Original_MaNhanVien, string Original_TenNhanVien, string Original_Phai, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_SDT, string Original_Email) {
        ...
        public virtual int Insert(string MaNhanVien, string TenNhanVien, string Phai, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string SDT, string Email) {
            if ((MaNhanVien == null)) {
        ...
        public virtual int Update(string MaNhanVien, string TenNhanVien, string Phai, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string SDT, string Email, string Original_MaNhanVien, string Original_TenNhanVien, string Original_Phai, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_SDT, string Original_Email) {
            if ((MaNhanVien == null)) {
                throw new global::System.ArgumentNullException("MaNhanVien");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenNhanVien, string Phai, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string SDT, string Email, string Original_MaNhanVien, string Original_TenNhanVien, string Original_Phai, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_SDT, string Original_Email) {
            return this.Update(Original_MaNhanVien, TenNhanVien, Phai, NgaySinh, DiaChi, SDT, Email, Original_MaNhanVien, Original_TenNhanVien, Original_Phai, Original_NgaySinh, Original_DiaChi, Original_SDT, Original_Email);
        }
    }
